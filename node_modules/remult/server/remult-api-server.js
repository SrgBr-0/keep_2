...
var RemultServerImplementation = /** @class */ (function () {
    ...
    RemultServerImplementation.prototype.registerRouter = function (r) {
        ...
        {
            try {
                for (var _d = tslib_1.__values(this.options.controllers), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var c = _e.value;
                            ...
                            if (remult.isAllowed(allowed)) {
                                if (((_a = orig === null || orig === void 0 ? void 0 : orig.params) === null || _a === void 0 ? void 0 : _a.id) === '__entities-metadata') {
                                    res.success((0, remult_admin_js_1.buildEntityInfo)({
                                        remult: remult,
                                        entities: (_b = this.options.entities) !== null && _b !== void 0 ? _b : [],
                                    }));
                                }
                                else {
                                    ...
                                    origResponse.send((0, remult_admin_js_1.default)({
                                        rootPath: (_c = this.options.rootPath) !== null && _c !== void 0 ? _c : '/api',
                                        head: head,
                                    }));
                                }
                            }
        ...
        (_c = this.options.entities) === null || _c === void 0 ? void 0 : _c.forEach(function (e) {
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 5:
                                        _a.sent();
                                        _a.label = 6;
                                    case 6: return [4 /*yield*/, what(remult, myReq, myRes, genReq, origRes, req)];
                                    case 7:
                                        _a.sent();
                                        return [3 /*break*/, 9];
                                    case 8:
